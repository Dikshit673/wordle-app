...
/**
 * Creates a HMAC signature for a given body and path.
 * @param body - The request body object.
 * @param path - The path of the request. Defaults to '/auth/init'.
 * @returns A promise with an object containing the HMAC signature and the timestamp.
 */
